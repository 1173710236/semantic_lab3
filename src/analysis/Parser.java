...
public class Parser
{
	...
	public Parser(String filename, ArrayList<Tree> tree)
	{
		this.lex = new Lexicalanalysis(readfile(filename), this.tokenList);
	...
	public void analyze()
	{
		...
		{			
			...
			{
				Pro derivation = Grammar.F.get(Integer.parseInt(action.substring(1)));
			...
			else if(action.equals(Table.acc))
			{
