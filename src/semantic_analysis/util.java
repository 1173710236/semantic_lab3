...
public class util
{
	...
	public static String print_ins(List<String> three_addr, List<Four> four_addr)
	{
		StringBuffer s = new StringBuffer();
		for (int i=0; i<three_addr.size(); i++)
		{
			s.append((Smanticanalysis.initial + i) + ":  \t");
	...
	public static String print_table(List<Stack<Sym>> table)
	{
		StringBuffer s = new StringBuffer();
	...
	public static Object[][] gui_ins(List<String> three_addr, List<Four> four_addr)
	{
